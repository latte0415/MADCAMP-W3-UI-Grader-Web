import { ValidateUrlResponse, AnalyzeResponse, SiteEvaluation, ApiError, RunsListResponse } from '@/types/api'
...
class ApiClient {
  ...
  async getEvaluation(runId: string, includeDetails: boolean = true): Promise<SiteEvaluation> {
    const params = new URLSearchParams({
      include_details: includeDetails.toString(),
    })
    return this.request<SiteEvaluation>(`/api/evaluation/${runId}?${params}`)
  }
